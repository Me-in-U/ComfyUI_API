...
def human_plus_dress(
    workflow, input_path, positive_prompt, negative_prompt, save_previews=False
):
    ...
    positive_prompt_id = [
        ...
        and value["_meta"]["title"] == "Positive Prompt(SB)"
    ][0]
    ...
    negative_prompt_id = [
        ...
        for key, value in prompt.items()
        if value["class_type"] == "CLIPTextEncode"
        and value["_meta"]["title"] == "Negative Prompt(SB)"
    ][0]
    ...
    k_sampler_id = [
        ...
        and value["_meta"]["title"] == "KSampler(SB)"
    ][0]
    ...
    image_loader = [
        ...
        and value["_meta"]["title"] == "human_image(SB)"
    ][0]
