...
def vton_dress_cat(workflow, input_path1, input_path2, save_previews=False):
    ...
    seed = [
        ...
        if value["class_type"] == "LayerUtility: Seed"
        and value["_meta"]["title"] == "LayerUtility: Seed"
    ][0]
    prompt[seed]["inputs"]["seed"] = generate_random_int()
    ...
    image_loader1 = [
        ...
        and value["_meta"]["title"] == "human_image"
    ][0]
    ...
    image_loader2 = [
        ...
        for key, value in prompt.items()
        if value["class_type"] == "LoadImage"
        and value["_meta"]["title"] == "clothes_image"
    ][0]
